// =============================================================
//  SOBEL_FILTER_OMP.CPP
//  -----------------------------------------------------------
//  Esta versión implementa el filtro Sobel usando OpenMP
//  para paralelización automática. Optimizada solo para
...
int main(int argc, char** argv) {
    ...
    std::cout << "=== Filtro Sobel con OpenMP ===" << std::endl;
    ...
    cv::Mat outputImagePar = sobelFilter.applySobel(inputImage);
    ...
    cv::namedWindow("Filtro Sobel (OpenMP)", cv::WINDOW_AUTOSIZE);
    cv::namedWindow("Sobel con Umbral", cv::WINDOW_AUTOSIZE);
    
    cv::imshow("Imagen Original", inputImage);
    cv::imshow("Filtro Sobel (OpenMP)", outputImagePar);
